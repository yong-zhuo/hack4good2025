    ...
    return (
        <div className="fixed inset-x-0 top-0 z-[15] h-[75px] bg-[#3E5879] py-2">
            <div className="mx-auto flex h-full items-center justify-between gap-2 px-8 sm:max-w-7xl md:max-w-full ">
                <div className='flex flex-row gap-1 items-center font-sans text-xl font-bold text-orange-500'><Link href="/inventory" className='text-orange-400 flex items-center justify-center gap-1 font-sans font-extrabold text-xl'><ShoppingCart className='text-orange-400' />Minimart@MWH <span className='font-bold text-xl text-orange-500'>for admins</span></Link> </div>
